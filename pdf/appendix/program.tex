...
The program will take any input from the console and print it directly to the console prefixed with `From console: '. It will also send the same input to a UDP port 9000 on localhost, and print any input received on that port to the console prefixed with `From port: '.
