...
%Note, this creates the problem of suddenly, you have two signals with the same tail. Therefore, we must explicitly call the garbage collector. Reference counting would save us.
