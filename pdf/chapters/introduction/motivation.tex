...
\section{Modal Types}
To avoid space leaks (and to guarantee other operational properties such as causality and productivity), previous works introduces \textit{modal types}\cite{gebser_asynchronous_2023}. 
