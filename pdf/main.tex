...
\begin{abstract}
This report presents the implementation of Rizzo, a functional reactive programming (FRP) library implemented in OCaml. Rizzo is based on the design presented in \cite{rizzo_modal_2025}, which introduces a simplified type system for FRP while preserving safety guarantees. The report covers the necessary background knowledge, the core implementation of Rizzo, and discusses potential future work.
\end{abstract}
\setcounter{page}{1}
\clearpage
