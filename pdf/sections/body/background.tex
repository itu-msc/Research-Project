...
Rizzo provides a number of functions and types that can be used to work with signals. Some of the most notable functions and types are:

\todo{shorten and remove types that are not interesting}
